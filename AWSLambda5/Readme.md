...
WORKDIR /src
COPY ["AWSLambda5.csproj", "AWSLambda5/"]
RUN dotnet restore "AWSLambda5/AWSLambda5.csproj"

WORKDIR "/src/AWSLambda5"
COPY . .
RUN dotnet build "AWSLambda5.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "AWSLambda5.csproj" \
...
Execute unit tests
```
cd "AWSLambda5/test/AWSLambda5.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "AWSLambda5/src/AWSLambda5"
